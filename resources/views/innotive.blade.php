    ...
    <div class="container">
      ...
      <div class="forms-container">
        <div class="signin-signup">
          ...
          @endif
          <form action="{{ route('actionlogin') }}" method="POST" class="sign-in-form" id="sign-in-form">
            @csrf
        ...
        @endif
          <form action="{{route('actionregister')}}" method="post" class="sign-up-form" id="sign-up-form">
            @csrf
